...
<!-- badges: start -->
[![Codecov test coverage](https://codecov.io/gh/thgsponer/stadlColorPaletteR/branch/master/graph/badge.svg)](https://app.codecov.io/gh/thgsponer/stadlColorPaletteR?branch=master)
<!-- badges: end -->
...
#> Error in library(stadlColorPaletteR): there is no package called 'stadlColorPaletteR'
## basic example code
```
