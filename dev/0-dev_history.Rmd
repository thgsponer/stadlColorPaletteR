...
fusen::fill_description(
  ...
  fields = list(
    Title = "STADL color palettes",
    Description = "Build color palettes based on the five basic STADL colors.",
    `Authors@R` = c(
      person("Thomas", "Thomas", email = "thomas.gsponer@stadl-partners.ch", role = c("aut", "cre"), comment = c(ORCID = "0000-0000-0000-0000"))
    )
  )
)
# Define License with use_*_license()
usethis::use_mit_license("Thomas Gsponer")
```
...
usethis::git_default_branch_rename(to = 'master')
```
